  ...
  return (
    <section className="w-full py-3">
      <div className="container px-2 md:px-2">
        <div className="grid">
          <div className="lg:min-h-80 md:min-h-80 md:mx-auto mx-8size-max sm:min-h-64 p-6 md:p-8 rounded-xl bg-slate-200 overflow-hidden shadow-lg flex flex-col justify-between">
