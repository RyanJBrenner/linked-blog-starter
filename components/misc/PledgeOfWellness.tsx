            ...
            <div className="mx-auto max-w-screen-md sm:text-left">
                ...
                <div className="mx-auto mb-3 space-y-4 max-w-screen-sm flex-col sm:space-y-0">
                    ...
                    <div className="relative w-full">
                        ...
                        <input className="block p-3 my-3 pl-10 w-full text-sm text-gray-200 bg-transparent rounded-full border-b border-gray-700 focus:ring-primary-300 focus:border-primary-300 dark:bg-gray-700 dark:border-gray-600placeholder-gray-900/80 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                    ...
                    <ul className="flex flex-wrap justify-start items-start mb-6 text-gray-900 dark:text-white list-item=[disc]">
                    ...
                    <input className="block p-3 my-3 pl-10 w-full text-sm text-gray-100 bg-transparent rounded-full border-b border-gray-900 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-900/80 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                    ...
                    <div>
                    <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded border cursor-pointer bg-blue-700 border-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Subscribe
                    </button>
                    </div>
                </div>
