        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            <ul className="flex grow justify-end flex-wrap items-center">
              <div>
                <Link href={"/health-optimization/health-optimization"} passHref={true} className="text-gray-900 hover:text-blue-400 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">
                  Health Optimization
                </Link>
              </div>
              <div>
                <Link href={"/fitness/exercise-fitness"} passHref={true} className="text-gray-900 hover:text-blue-400 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">
                  Exercise & Fitness
                </Link>
              </div>
              <div>
                <Link href={"/diet-nutrition/diet-nutrition"} passHref={true} className="text-gray-900 hover:text-blue-400 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">
                  Diet & Nutrition
                </Link>
              </div>
            </ul>
            ...
            <li>
                <Link href="https://www.yudaewellness.com/shop" className="btn-md text-gray-200 bg-blue-500 hover:bg-blue-900/30 my-8">
                  <span>Shop</span>
          ...
          <div className="flex md:hidden">
            <button onClick={toggleMobileNav} className="hamburger false" aria-controls="mobile-nav" aria-expanded="false">
              ...
              <svg className="w-6 h-6 fill-current text-blue-400 hover:text-blue-400/20 " viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              <nav id="mobile-nav" className={`absolute top-full h-screen pb-16 z-20 left-0 w-full overflow-scroll bg-white/20 backdrop-blur-lg ${mobileNavVisible ? 'block' : 'hidden'}`}>
                <ul className="px-5 py-2">
                  <li>
                    <Link onClick={toggleMobileNav} href={"/health-optimization/health-optimization"} className="text-blue-600 hover:text-blue-900/30 px-3 lg:px-5 py-4 flex items-center transition duration-150 ease-in-out">Health Optimization</Link>
                  </li>
                  <li>
                    <Link onClick={toggleMobileNav} href={"/fitness/exercise-fitness"} className="text-blue-600 hover:text-blue-900/30 px-3 lg:px-5 py-4 flex items-center transition duration-150 ease-in-out">Fitness & Exercise</Link>
                  </li>
                  <li>
                    <Link onClick={toggleMobileNav} href={"/diet-nutrition/diet-nutrition"} className="text-blue-600 hover:text-blue-900/30 px-3 lg:px-5 py-4 flex items-center transition duration-150 ease-in-out">Diet & Nutrition</Link>
                  </li>
                  <li>
                    <Link onClick={toggleMobileNav} href="https://www.yudaewellness.com/shop" className="btn-sm text-gray-200 bg-blue-500 hover:bg-blue-900/80 ml-3 my-4 transition-all ease-in-out">
                      <span>Shop</span>
                      <svg className="w-3 h-3 fill-current text-gray-200 shrink-0 ml-2 -mr-1" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.707 5.293L7 .586 5.586 2l3 3H0v2h8.586l-3 3L7 11.414l4.707-4.707a1 1 0 000-1.414z" fillRule="nonzero" />
                      </svg>
