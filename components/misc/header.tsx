      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
                <Link href="https://docs.fleetingnotes.app/getting-started/download" className="btn-md text-gray-200 bg-blue-400 hover:bg-blue-500 my-8">
                  <span>Shop</span>
            ...
            <div>
              <nav id="mobile-nav" className={`absolute top-full h-screen pb-16 z-20 left-0 w-full overflow-scroll bg-white ${mobileNavVisible ? 'block' : 'hidden'}`}>
                <ul className="px-5 py-2">
                  ...
                  <li>
                    <Link onClick={toggleMobileNav} href="https://docs.fleetingnotes.app/getting-started/download" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3 my-4 transition-all ease-in-out">
                      <span>Shop</span>
