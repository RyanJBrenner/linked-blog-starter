      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <div>
                <NextLink legacyBehavior href={`${router.basePath}/common_md/optimization`} passHref>
                  <a className="text-blue-500 hover:text-blue-400 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">
                    Health Optimization
                  </a>
                </NextLink>
              </div>
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <NextLink legacyBehavior href="https://docs.fleetingnotes.app/getting-started/download" passHref>
                  <a className="btn-md text-gray-200 bg-blue-400 hover:bg-blue-500 my-8">
                    <span>Shop</span>
          ...
          <div className="flex md:hidden">
            ...
            <div>
              <nav id="mobile-nav" className={`absolute top-full h-screen pb-16 z-20 left-0 w-full overflow-scroll bg-white/30 backdrop-blur-lg ${mobileNavVisible ? 'block' : 'hidden'}`}>
