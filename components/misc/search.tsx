...
function Search({ visible, setVisible }) {
  ...
  return (
    <div className={`absolute top-20 h-screen pb-16 z-20 left-0 w-full overflow-y-auto overscroll-none overflow-x-hidden bg-white/95 ${visible ? "block" : "hidden"}`}>
      <div ref={containerRef} className="max-w-4xl mx-auto flex flex-wrap mt-5 px-5">
        ...
        <div className="w-full">
          ...
          <div className="relative flex items-center">
            <input ref={inputRef} id="search" type="search" className="form-input w-full text-gray-800 px-3 py-2 pl-10" placeholder="What would you like to learn?" onChange={handleChangeInput}/>
